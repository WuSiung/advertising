...
const StaticsSetUp: FC<StaticsSetUpProps> = (props) => {
  ...
  return (<>
    ...
    >
      <div>如果今天暂停的广告集的<span className="em">{statics[staticsIdx].label}</span>是 低或等于<span className="em">{props.installfeeValue?.mertricType===2?props.installfeeValue?.value:props.installfeeValue?.staticMetricValue}</span><Button type="link"></Button></div>
