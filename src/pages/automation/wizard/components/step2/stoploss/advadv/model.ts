import { TModelStopLossAdv } from "@/pages/automation/wizard/components/step2/stoploss/advadv/data";
import moment from 'moment';

const FORMAT = 'HH:mm';
const TACTIC_NAME = '止损-广告水平 触发 -> ';
...
const StopLossAdvModel: TModelStopLossAdv = {
  namespace: 'stopLossAdv',
  state: {
    Name: '',
    ActionInfo: {
      installValue: 1,
...
createName(StopLossAdvModel.state);

export default StopLossAdvModel;
