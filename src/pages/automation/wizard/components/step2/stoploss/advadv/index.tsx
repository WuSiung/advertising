...
const Setting: FC<{}> = (props) => {
  ...
  return (<>
   { <SettingHeadCard title="止损广告位" icon={<SvgStopLoss fill="#d964c5"/>} pictrue={<SvgStopLossPicAds/>} subTitle="我们已经准备了止损策略，以适应渠道中的各种事件。选择您想要作为止损基础的事件，我们将为您推荐该事件的最佳预测止损指标，或者跳过此步骤并从头开始制定策略。" />}
...
const StopLossAdvAdv: ForwardRefExoticComponent<Pick<StopLossAdvSetProps,any>> = forwardRef((props, ref) => {
