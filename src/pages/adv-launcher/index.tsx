...
const tabContent = {
    'workbench': '通过广告启动器，您可以在工作台和广告创意系列中启动新广告或现有广告。这是您的内容中心，您可以在公共素材库选择最新的素材在工作台批量生成全新广告，也可以选择热门广告和保存的广告素材重新组合广告。在这里，您还可以查看广告素材和广告文案的效果，并将最佳效果组合成可盈利的新广告，设置覆盖人群和facebook设置进行批量投放。',
